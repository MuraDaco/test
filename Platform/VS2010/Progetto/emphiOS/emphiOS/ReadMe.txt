========================================================================
   APPLICAZIONE: cenni preliminari sul progetto emphiOS
========================================================================
...
emphiOS.cpp
    ...
    Contiene il codice per la visualizzazione del form.

Form1.h
    Contiene l'implementazione della classe del form e la funzione 
    InitializeComponent().

AssemblyInfo.cpp
    Contiene attributi personalizzati per la modifica dei metadati degli 
    assembly.
...
StdAfx.h, StdAfx.cpp
    ...
    precompilato denominato emphiOS.pch e un file dei tipi 
