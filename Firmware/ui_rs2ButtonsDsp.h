...
#define	ROW_VAR_RS2_BUTTONS_TIMES_PRESSED		{	ID_STR_VAR_RS2_BUTTONS_TIMES_PRESSED		,(unsigned char *) &rs2ButtonsTimesPressed		,sizeof(rs2ButtonsTimesPressed)		,WORD			,DIGIT_3		}
