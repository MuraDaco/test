...
#if defined(_DEF_C) || defined(_TIMER_C) || defined(_TEST_C) || defined(_TOUCH_C) || defined(_HW_LCD_C) || \
    defined(_BUTTONS_C) || defined(_UI_PAR_C) || defined(_UI_VAR_C) || defined(_UI_LBOX_C) || \
    defined(FW_TEST_H)
